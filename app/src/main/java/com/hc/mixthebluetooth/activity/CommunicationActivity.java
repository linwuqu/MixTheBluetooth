...
public class CommunicationActivity extends BaseActivity<ActivityCommunicationBinding> {
    ...
    public void onClickView(View view) {
        ...
        if (isCheck(viewBinding.log)) viewBinding.communicationFragment.setCurrentItem(4);
        ...
        if (isCheck(viewBinding.ionAnalysis)) viewBinding.communicationFragment.setCurrentItem(3);
    }
    ...
    private void initFragment() {
        ...
        //manage.addFragment(FragmentIonAnalysis.newInstance(mDeviceName)); //第一个fragment（离子浓度分析）
        ...
        viewBinding.communicationFragment.setOffscreenPageLimit(5);
        // 默认显示第一个页面（离子浓度分析）
