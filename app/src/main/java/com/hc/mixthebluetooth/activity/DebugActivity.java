...
public class DebugActivity extends BaseActivity<ActivityDebugBinding> {
    ...
    public void onClickView(View v) {
        if (isCheck(viewBinding.debugRead)) {
            ...
            startActivity(new Intent(this, ApiDebugActivity.class));
    ...
    private void initTitle() {
        new DefaultNavigationBar.Builder(this, findViewById(R.id.debug_activity)).setTitle("Bug日志").hideLeftText().hideRightText().builer();
    }
