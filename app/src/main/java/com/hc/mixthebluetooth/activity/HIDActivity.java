...
public class HIDActivity extends BaseActivity<ActivityHidBinding> {
    ...
    private void initView() {
        ...
        bindClickListener(this::startImage, viewBinding.aHintImage1, viewBinding.aHintImage2, viewBinding.aHintImage3, viewBinding.aHintImage4);
    }
    ...
    public void onClickView(View view) {
        if (isCheck(viewBinding.aHintWebDownload1) || isCheck(viewBinding.aHintWebDownload2))
            setText("http://www.hc01.com/download");
        if (isCheck(viewBinding.aHintDownloadFramework))
            setText("https://pan.baidu.com/s/1oO97-wgyiQh8P9DHHFNt8A");
    }
    ...
    private void setTitle() {
        new DefaultNavigationBar.Builder(this, (ViewGroup) findViewById(R.id.hid_name)).setTitle("下载步骤").builer();
    }
