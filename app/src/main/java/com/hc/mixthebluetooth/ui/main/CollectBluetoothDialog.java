...
public class CollectBluetoothDialog extends LinearLayout {
    ...
    public CollectBluetoothDialog(Context context) {
        this(context,null);
    }

    public CollectBluetoothDialog(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CollectBluetoothDialog(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public CollectBluetoothDialog setBuilder(CommonDialog.Builder mBuilder) {
        this.mBuilder = mBuilder;
        return this;
    }

    public CollectBluetoothDialog setDevice(DeviceModule device){
