package com.hc.mixthebluetooth.ui.shared.view;
...
public class CheckBoxSample extends View implements Checkable {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(getMeasuredWidth() / 2f, getMeasuredHeight() / 2f, rad - dp(1), borderPaint);

        bitmapPaint.setColor(bitmapColor);

        bitmapCanvas.drawCircle(getMeasuredWidth() / 2f, getMeasuredHeight() / 2f, rad, bitmapPaint);
        bitmapCanvas.drawCircle(getMeasuredWidth() / 2f, getMeasuredHeight() / 2f, rad * (1 - bitmapProgress), bitmapEraser);
        ...
        checkCanvas.drawCircle(getMeasuredWidth() / 2f, getMeasuredHeight() / 2f, rad * (1 - checkProgress), checkEraser);
