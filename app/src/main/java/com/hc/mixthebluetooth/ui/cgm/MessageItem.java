...
public class MessageItem {
    ...
    public MessageItem(String data,String time,boolean isMyData,DeviceModule module,boolean isShowMe){
        this.data = data;
    ...
    public MessageItem(boolean isHex,byte[] data,String time,boolean isMyData,DeviceModule module,boolean isShowMe){
        this.byteData = data;
        this.isMyData = isMyData;
        this.module = module;
        this.isShowMe = isShowMe;
