...
public class MainActivity extends BaseActivity<ActivityMainBinding> {
    ...
    private DeviceListAdapter mainRecyclerAdapter;
    ...
    private void initView() {
        setMainBackIcon();
        mainRecyclerAdapter = new DeviceListAdapter(this, mFilterModuleArray, R.layout.item_recycler_main);
    ...
    private void setPopWindow(View v) {
        new DeviceFilterDialog(v, MainActivity.this, resetEngine -> {//弹出窗口销毁的回调
            upDateList();
    ...
    private void setCollectWindow(int position) {
        ...
        CollectBluetoothDialog collectBluetooth = collectBuilder.getView(R.id.hint_collect_vessel_view);
